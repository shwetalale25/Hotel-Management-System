							...
							<form action="index.php?page=list" id="filter" method="POST">
								<div class="row">
									<div class="col-md-3">
										...
										<input type="text" class="form-control datepicker" name="date_in"
											autocomplete="off">
									</div>
									<div class="col-md-3">
...
<div id="portfolio">
	<div class="container-fluid p-0">
		<h2 class="text-center mb-5">Rooms Categories</h2>
		<div class="row no-gutters">
			...
			while ($row = $qry->fetch_assoc()):
				...
				<div class="col-lg-6 col-sm-6">
					<a class="portfolio-box m-2" href="#">
						<img class="w-100" src="assets/img/<?php echo $row['cover_img'] ?>" alt="" />
						<div class="portfolio-box-caption">
							<div class="project-category text-white-30">
								<?php echo "$ " . number_format($row['price'], 2) ?> per day
							</div>
